...
import { lyra_prompt, lyra_greeting} from '../OpenAI/prompts';
...
export default function LyraChatScreen() {
  ...
  const instructionPrompt = { role: 'system', content: `Context about user: ${userProfile}. System instructions: ${lyra_prompt}`};
  const greetingPrompt = { role: 'system', content: `${lyra_greeting}`};
  ...
  useEffect(() => {
    const initializeChatHistory = async () => {
      ...
      const instructionPrompt = {
        role: 'system',
        content: `Context about user: ${userProfile}. System instructions: ${lyra_prompt}`,
      };
      if (entryText) {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground source={require('../assets/chat-lyra-background.png')} style={styles.bgImage}>
